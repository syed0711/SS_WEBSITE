...
export default function AzollaBedPage() {
  return (
    <div>
      <Navbar />
      <div className="bg-white py-6 sm:py-8">
        <div className="w-full px-4">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Azolla Beds</h2>
            <p className="mt-2 text-lg leading-8 text-gray-600">
              Purpose-built beds for azolla cultivation and bio-fertilizer production
            </p>
          </div>
          <div className="mx-auto mt-8 max-w-2xl grid grid-cols-1 gap-y-6 lg:max-w-4xl lg:grid-cols-2 gap-x-8">
            {azollaBedTypes.map((type) => (
